...
function matIV(){
	...
	this.multiplyPt = function(pt, mat, dest){
		var a = pt[0],  b = pt[1],  c = pt[2],  d = pt[3],
			A = mat[0],  B = mat[1],  C = mat[2],  D = mat[3],
			E = mat[4],  F = mat[5],  G = mat[6],  H = mat[7],
			I = mat[8],  J = mat[9],  K = mat[10], L = mat[11],
			M = mat[12], N = mat[13], O = mat[14], P = mat[15];
		dest[0] = a * A + b * B + c * C + d * D;
		dest[1] = a * E + b * F + c * G + d * H;
		dest[2] = a * I + b * J + c * K + d * L;
		dest[3] = a * M + b * N + c * O + d * P;
		return dest;
	};
}
/*--------------------------------------------------------------------------------------------*/
